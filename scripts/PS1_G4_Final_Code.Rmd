...
ggplot(df_errores, aes(x = error)) +
  ...
  geom_vline(xintercept = Mean_errorsA2VS, color = "green", linetype = "dashed", size = 1) +
  geom_vline(xintercept = Mean_errorsA2VS + 2 * sd_errorsA2VS, color = "red", linetype = "dashed", size = 1) +
  geom_vline(xintercept = Mean_errorsA2VS - 2 * sd_errorsA2VS, color = "red", linetype = "dashed", size = 1) +
...
ggplot(Outliersdf, aes(x = y_ingLab_m)) +
  ...
  geom_vline(xintercept = mean(Outliersdf$y_ingLab_m), color = "darkgray", linetype = "dashed", size = 1) +
  labs(title = "Distribución del ingreso laboral mensual",
