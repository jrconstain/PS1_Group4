...
```{r}
db_clean = db %>% select(ingtot, y_ingLab_m, y_salary_m, y_salarySec_m, y_ingLab_m_ha, y_salary_m_hu, y_salarySec_m_ha, totalHoursWorked, hoursWorkUsual, hoursWorkActualSecondJob, age, sex, estrato1, maxEducLevel, college, edu_years, exp, oficio, relab, formal, regSalud, sizeFirm, p6240, ocu, dsi)

write.csv(db, "db_clean.csv", row.names = FALSE)
```